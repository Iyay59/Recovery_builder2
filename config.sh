...
# about your device
export DEVICE="a5s" # codename used in device tree
export DT_LINK="https://github.com/twrpdtgen/android_device_inone_A5s" # device tree link
export DT_BRANCH="twrp" # device tree branch
export VENDOR="inone" # device manufacturer or vendor
